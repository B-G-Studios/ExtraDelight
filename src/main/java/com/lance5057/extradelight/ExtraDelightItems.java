...
import net.minecraft.world.item.component./* ItemContainerContents replaced with capability */;
...
public class ExtraDelightItems {
	public static final DeferredRegister.Items ITEMS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.ITEMS, ExtraDelight.MOD_ID);
...
//			.register("mint_jelly", () -> new Item(foodItem(EDFoods.JAM))).advancementIngredients().finish();
	...
	public static final RegistryObject<Item> JAM = EDItemGenerator.register("jam", () -> new DeprecatedItem() {
		...
		public ItemStack changeToStack(ItemStack stack) {
			...
			jam.set(ExtraDelightComponents.ITEMSTACK_HANDLER.get(), /* ItemContainerContents replaced with capability */.fromItems(l));
