...
public class ExtraDelightTags {
	...
	public static TagKey<Fluid> modFluidTag(String tag) {
		return FluidTags.create(new ResourceLocation("extradelight", tag));
	}

	public static TagKey<Item> butcherTag(String tag) {
		return ItemTags.create(new ResourceLocation("butchercraft", tag));
	}

	public static TagKey<Item> tanTag(String tag) {
		return ItemTags.create(new ResourceLocation("toughasnails", tag));
	}
	...
	public static final TagKey<Item> CAN_BE_SALTED = ItemTags
			.create(new ResourceLocation("salt", "can_be_salted"));
