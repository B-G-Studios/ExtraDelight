...
import net.minecraftforge.neoforge.client.model.renderable.BakedModelRenderable;
import net.minecraftforge.neoforge.client.model.renderable.IRenderable;
...
public class CornHuskDollRenderer implements BlockEntityRenderer<CornHuskDollBlockEntity> {
	...
	final ModelResourceLocation model_down = ModelResourceLocation
			.standalone(new ResourceLocation(ExtraDelight.MOD_ID, "extra/corn_husk_doll"));
	final ModelResourceLocation model_up = ModelResourceLocation
			.standalone(new ResourceLocation(ExtraDelight.MOD_ID, "extra/corn_husk_doll_hang"));
