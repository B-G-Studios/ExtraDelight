...
//			if (i < this.getMaxAge()) {
			...
			if (net.minecraftforge.neoforge.common.CommonHooks.canCropGrow(pLevel, pPos, pState,
					pRandom.nextInt((int) (25.0F / f) + 1) == 0)) {
				this.growCrops(pLevel, pPos, pState);
				net.minecraftforge.neoforge.common.CommonHooks.fireCropGrowPost(pLevel, pPos, pState);
//				}
			}
		}
...
//						(net.minecraftforge.neoforge.common.IPlantable) p_52273_)) {
//					f1 = 1.0F;
//					f1 = 1.0F;
