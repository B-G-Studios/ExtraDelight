...
import net.minecraftforge.neoforge.client.model.generators.BlockStateProvider;
import net.minecraftforge.neoforge.client.model.generators.ConfiguredModel;
import net.minecraftforge.neoforge.client.model.generators.ModelFile;
...
//				.withExistingParent("cooking_oil", mcLoc("block/carpet")).texture("wool", modLoc("block/cooking_oil")));
		...
		trapdoorBlock(
				ExtraDelightBlocks.CINNAMON_TRAPDOOR.get(), models()
						.withExistingParent("cinnamon_trapdoor_bottom",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_bottom"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cinnamon_trapdoor"))
						.renderType("cutout"),
				models().withExistingParent("cinnamon_trapdoor_top",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_top"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cinnamon_trapdoor"))
						.renderType("cutout"),
				models().withExistingParent("cinnamon_trapdoor_open",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_open"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cinnamon_trapdoor"))
						.renderType("cutout"),
				true);
		...
		simpleBlock(ExtraDelightBlocks.CANDY_BOWL.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/candy_bowl")));
		...
		doorBlock(ExtraDelightBlocks.DARK_CHOCOLATE_DOOR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_door_bottom"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_door_top"));
		trapdoorBlock(
				ExtraDelightBlocks.DARK_CHOCOLATE_TRAPDOOR.get(), models()
						.withExistingParent("dark_chocolate_trapdoor_bottom",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_bottom"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_trapdoor")),
				...
				models().withExistingParent("dark_chocolate_trapdoor_open",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_open"))
						.texture("texture", new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_trapdoor")),
				true);
		...
		axisBlock(ExtraDelightBlocks.DARK_CHOCOLATE_PILLAR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_pillar"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/dark_chocolate_style0"));
		...
		doorBlock(ExtraDelightBlocks.MILK_CHOCOLATE_DOOR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_door_bottom"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_door_top"));
		trapdoorBlock(
				ExtraDelightBlocks.MILK_CHOCOLATE_TRAPDOOR.get(), models()
						.withExistingParent("milk_chocolate_trapdoor_bottom",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_bottom"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_trapdoor")),
				...
				models().withExistingParent("milk_chocolate_trapdoor_open",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_open"))
						.texture("texture", new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_trapdoor")),
				true);
		...
		axisBlock(ExtraDelightBlocks.MILK_CHOCOLATE_PILLAR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_pillar"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/milk_chocolate_style0"));
		...
		doorBlock(ExtraDelightBlocks.WHITE_CHOCOLATE_DOOR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_door_bottom"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_door_top"));
		trapdoorBlock(
				ExtraDelightBlocks.WHITE_CHOCOLATE_TRAPDOOR.get(), models()
						.withExistingParent("white_chocolate_trapdoor_bottom",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_bottom"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_trapdoor")),
				...
				models().withExistingParent("white_chocolate_trapdoor_open",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_open"))
						.texture("texture", new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_trapdoor")),
				true);
		...
		axisBlock(ExtraDelightBlocks.WHITE_CHOCOLATE_PILLAR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_pillar"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/white_chocolate_style0"));
		...
		doorBlock(ExtraDelightBlocks.BLOOD_CHOCOLATE_DOOR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_door_bottom"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_door_top"));
		trapdoorBlock(
				ExtraDelightBlocks.BLOOD_CHOCOLATE_TRAPDOOR.get(), models()
						.withExistingParent("blood_chocolate_trapdoor_bottom",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_bottom"))
						.texture("texture",
								new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_trapdoor")),
				...
				models().withExistingParent("blood_chocolate_trapdoor_open",
						new ResourceLocation(ExtraDelight.MOD_ID, "block/chocolate_trapdoor_open"))
						.texture("texture", new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_trapdoor")),
				true);
		...
		axisBlock(ExtraDelightBlocks.BLOOD_CHOCOLATE_PILLAR.get(),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_pillar"),
				new ResourceLocation(ExtraDelight.MOD_ID, "block/cosmetics/chocolate/blood_chocolate_style0"));
		...
		simpleBlock(ExtraDelightBlocks.JAR.get(),
				models().getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/jar")));
		...
		simpleBlock(ExtraDelightBlocks.HANGING_ONIONS.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_onions")));
		simpleBlock(ExtraDelightBlocks.HANGING_MINT.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_mint")));
		simpleBlock(ExtraDelightBlocks.HANGING_HAM.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_ham")));
		simpleBlock(ExtraDelightBlocks.HANGING_CHILI.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_chili")));
		simpleBlock(ExtraDelightBlocks.HANGING_DRIED_CHILI.get(), models().getExistingFile(
				new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_dried_chili")));
		simpleBlock(ExtraDelightBlocks.HANGING_CORN.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_corn")));
		...
		simpleBlock(ExtraDelightBlocks.HANGING_GARLIC.get(), models()
				.getExistingFile(new ResourceLocation(ExtraDelight.MOD_ID, "block/hanging_garlic")));
