...
import net.minecraftforge.neoforge.common.data.DataMapProvider;
import net.minecraftforge.neoforge.registries.datamaps.builtin.Compostable;
import net.minecraftforge.neoforge.registries.datamaps.builtin.NeoForgeDataMaps;
