...
public class EDBiomeModifiers extends BaseDatapackRegistryProvider {
	...
	private static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
			.add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, context -> {
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_corn")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_coffee")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_ginger")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_chili")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_peanut")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_mallow")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_mint")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_garlic")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_cucumber")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "patch_wild_soybean")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "cinnamon_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "hazelnut_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "apple_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "lemon_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "lime_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "orange_tree")),
				...
				context.register(
						biomeModifier(new ResourceLocation(ExtraDelight.MOD_ID, "grapefruit_tree")),
