...
public class VatRecipeCategory implements IRecipeCategory<VatRecipe> {
	...
	public VatRecipeCategory(IGuiHelper guiHelper) {
		background = guiHelper.createDrawable(
				new ResourceLocation(ExtraDelight.MOD_ID, "textures/gui/jei3.png"), 0, 0, 101, 47);
		stage = guiHelper.createDrawable(
				new ResourceLocation(ExtraDelight.MOD_ID, "textures/gui/jei3.png"), 0, 47, 101, 31);
		finish = guiHelper.createDrawable(
				new ResourceLocation(ExtraDelight.MOD_ID, "textures/gui/jei3.png"), 0, 78, 101, 33);
