...
import net.minecraftforge.neoforge.common.EffectCures;
...
public class XocolatlItem extends DrinkableItem {
	...
	public void affectConsumer(ItemStack stack, Level level, LivingEntity consumer) {
		...
		if (compatibleEffects.size() > 0) {
			...
			if (selectedEffect != null && !net.minecraftforge.neoforge.event.EventHooks.onEffectRemoved(consumer, selectedEffect, EffectCures.MILK)) {
