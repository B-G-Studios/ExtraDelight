...
import net.minecraftforge.neoforge.fluids.FluidUtil;
import net.minecraftforge.neoforge.fluids.capability.IFluidHandler;
import net.minecraftforge.neoforge.fluids.capability.IFluidHandler.FluidAction;
import net.minecraftforge.neoforge.fluids.capability.IFluidHandlerItem;
import net.minecraftforge.neoforge.fluids.capability.templates.FluidTank;
